...
class Params:
    def __init__(self, gamma, lr, batch_size, test_batch_size, epochs):
        self.gamma = gamma
        self.lr = lr
...
def main():
    ...
    # experiment_name = "mnist_poc:" + str(datetime.datetime.fromtimestamp(time.time()).strftime('%Y-%m-%d %H:%M:%S'))
    experiment_name = "mnist:ConvNet_Dropout_"
    # experiment_id = mlflow.create_experiment(experiment_name)
    experiment_id = mlflow.set_experiment(args.experiment_name)
    print("------Starting experiment: " + str(experiment_name) + "with id: " + str(experiment_id) + "---------")
    with mlflow.start_run(experiment_id) as run:
        params = Params(args.gamma, args.lr, args.batch_size, args.test_batch_size, args.epochs)
